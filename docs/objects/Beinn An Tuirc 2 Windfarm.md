...
|:---------------|:------------|:--------------------------|
| root           | osuked_id   | 10157                     |
| element-of     | sett_bmu_id | E_BTUIW-2, E_BTUIW-3      |
| element-of     | ngc_bmu_id  | BTUIW-2, BTUIW-3          |
| same-as        | gppd_idnr   | GBR0004525                |
| same-as        | esail_id    | BTUIW                     |
| same-as        | name        | Beinn An Tuirc 2 Windfarm |
