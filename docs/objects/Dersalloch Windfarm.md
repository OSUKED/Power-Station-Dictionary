...
|:---------------|:------------|:--------------------|
| root           | osuked_id   | 10184               |
| element-of     | sett_bmu_id | T_DRSLW-1           |
| element-of     | ngc_bmu_id  | DRSLW-1             |
| same-as        | gppd_idnr   | GBR0004269          |
| same-as        | esail_id    | DRSLW               |
| same-as        | name        | Dersalloch Windfarm |
