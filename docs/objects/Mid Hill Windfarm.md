...
|:---------------|:------------|:------------------|
| root           | osuked_id   | 10223             |
| element-of     | sett_bmu_id | 2__PSTAT002       |
| element-of     | ngc_bmu_id  | MDHLW-1           |
| same-as        | gppd_idnr   | GBR0004667        |
| same-as        | esail_id    | PSTAT002          |
| same-as        | name        | Mid Hill Windfarm |
