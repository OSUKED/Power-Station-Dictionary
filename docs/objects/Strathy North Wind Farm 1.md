...
|:---------------|:------------|:--------------------------|
| root           | osuked_id   | 10240                     |
| element-of     | sett_bmu_id | T_STRNW-1                 |
| element-of     | ngc_bmu_id  | STRNW-1                   |
| same-as        | gppd_idnr   | GBR0004625                |
| same-as        | esail_id    | STRNW                     |
| same-as        | name        | Strathy North Wind Farm 1 |
